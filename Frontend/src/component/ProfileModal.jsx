          ...
          <form className="space-y-4" onSubmit={handleSaveprofile} action="">
              ...
              >
                ...
                <div className="group/cover relative">
                  <img
                    ...
                    className="w-80 h-40 rounded-lg bg-gradient-to-r from-red-200 via-yellow-200 to-purple-200 object-cover mt-2 "
                    alt=""
                  />
            ...
            <div className="flex justify-end space-x-3 pt-6">
              <button
                ...
                className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hovev:bg-gray-50 transition-colors cursor-pointer "
              >
                Cancel
              </button>
              <button
                type="submit"
                className="px-4 py-2 bg-gradient-to-r from-red-500 to-purple-600 text-white rounded-lg hover:from-red-600 hover:to-purple-700 transition cursor-pointer "
              >
                Save Changes
              </button>
            </div>
