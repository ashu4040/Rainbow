    ...
    <div className="fixed inset-0 z-110 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          {bgColors.map((color) => (
            <button
              ...
              className={`w-6 h-6 rounded-full ring cursor-pointer ${
                background === color ? "ring-2 ring-white" : "ring-transparent"
              }`}
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-gradient-to-r from-red-500 to-purple-600 hover:from-red-600 hover:to-purple-700 active:scale-95 transition cursor-pointer"
        >
