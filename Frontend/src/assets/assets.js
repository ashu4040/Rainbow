...
// assets.js (menuItemsData)
export const menuItemsData = [
  {
    to: "/",
    label: "Feed",
    Icon: Home,
    // hover + active are explicit
    hoverClasses: "hover:bg-red-100 hover:text-red-700",
  ...
  },
  {
    ...
    label: "Messages",
    Icon: MessageCircle,
    hoverClasses: "hover:bg-pink-100 hover:text-pink-700",
  ...
  },
  {
    ...
    label: "Connections",
    Icon: Users,
    hoverClasses: "hover:bg-yellow-100 hover:text-yellow-700",
    activeClasses: "bg-yellow-100 text-yellow-700",
  },
  {
    to: "/discover",
    label: "Discover",
    ...
    activeClasses: "bg-green-100 text-green-800",
  },
  {
    to: "/profile",
    label: "Profile",
    Icon: UserIcon,
    hoverClasses: "hover:bg-blue-100 hover:text-blue-700",
    activeClasses: "bg-blue-100 text-blue-800",
  },
];
...
export const dummyStoriesData = [
  {
    ...
    createdAt: "2025-08-25T02:06:06.958Z",
