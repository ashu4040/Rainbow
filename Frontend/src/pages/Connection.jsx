      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8 flex flex-wrap gap-6">
          {dataArray.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-1 border h-20 sm:w-40 w-36 border-gray-200 bg-white shadow rounded-md"
            >
                ...
                <div className="flex max-sm:flex-col gap-2 mt-4">
                  {
                    <button
                      ...
                      className="w-full p-2 text-sm rounded bg-gradient-to-r from-red-500 to-purple-600 hover:from-red-600 hover:to-purple-700 active:scale-95 transition text-white cursor-pointer"
                    >
                      View Profile
                    </button>
                  }
                  {currentTab == "Following" && (
                    <button className="w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-balck active:scale-95 transition cursor-pointer">
                      Unfollow
                    </button>
                  )}
                  {currentTab == "Pending" && (
